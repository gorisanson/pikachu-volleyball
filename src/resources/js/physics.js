 ...
 * {@link calculate_expected_landing_point_x_for} function and {@link expectedLandingPointXWhenPowerHit} function seems to be always terminated soon.
...
function physicsEngine(player1, player2, ball, userInputArray) {
  ...
  for (let i = 0; i < 2; i++) {
    ...
    // FUN_00402d90 include FUN_004031b0(calculate_expected_landing_point_x_for)
    calculate_expected_landing_point_x_for(ball); // calculate expected_X;
 ...
 * @param {Ball} ball
 */
function calculate_expected_landing_point_x_for(ball) {
  const copyBall = {
    x: ball.x,
    y: ball.y,
